...
class FlightService:
    ...
    def _get_iata_code(self, location: str) -> str:
        ...
        try:
            ...
            if data and "iataCode" in data[0]:
                ...
                logger.warning(
                    f"No IATA code found for location: {location} using refined keyword '{refined_keyword}'.")
    ...
    async def get_best_flight(self, extracted_details: Dict[str, Any]) -> str:
        ...
        try:
            ...
            dictionaries = response.result.get("dictionaries", {}) if hasattr(response, "result") and isinstance(
                response.result, dict) else {}
